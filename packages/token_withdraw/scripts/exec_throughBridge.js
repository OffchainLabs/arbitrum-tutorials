...
const withdrawRes = await bridge.withdrawERC20( erc20Address, tokenWithdrawAmount)
...
const l2Data2 = await bridge.getAndUpdateL2TokenData(erc20Address)
const testWalletL2Balance2 = l2Data2 && l2Data2.ERC20 && l2Data2.ERC20.balance
    
expect(testWalletL2Balance2.add(tokenWithdrawAmount).eq(testWalletL2Balance)).to.be.true
