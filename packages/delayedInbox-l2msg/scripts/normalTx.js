...
const main = async () => {
  ...
  const Greeter = (await ethers.getContractFactory('Greeter')).connect(childChainWallet);
  ...
  const calldata = GreeterIface.encodeFunctionData('setGreeting', [newGreetingToSet]);
