...
const main = async () => {
  ...
  /**
   * For the purpose of our tests, here we deploy an ERC1400 token (ERC1400Token) to L1
  ...
  const l1Erc1400Address = l1ERC1400Token.address
  ...
  const approveTx = await erc20Bridger.approveToken({
    l1Signer: l1Wallet,
    erc20L1Address: l1Erc1400Address,
  })
  ...
  /**
   * ... Okay, Now we begin withdrawing ERC1400Token from L2. To withdraw, we'll use Erc20Bridger helper method withdraw
   ...
   * We'll check our l2Wallet ERC1400Token balance here:
   */
  const l2Token = erc20Bridger.getL2TokenContract(
    l2Provider,
    await erc20Bridger.getL2ERC20Address(l1Erc1400Address, l1Provider)
  )
