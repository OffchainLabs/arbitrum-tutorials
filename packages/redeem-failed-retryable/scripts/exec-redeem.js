...
module.exports = async txnHash => {
  ...
  */
  const autoRedeemRec = await getRawArbTransactionReceipt(l2Provider,message.autoRedeemId)
  ...
  switch(autoRedeemRec.returnCode)
  {
    ...
    case 8:
      console.log(`Auto redeem failed; exceeded the tx gas limit ; you can redeem it now:`)
    case 10:
      console.log(`Auto redeem failed; gas provided is below minimum tx gas; you can redeem it now:`)
    case 11:
      console.log(`Auto redeem failed; L2 gas price is set too low; you can redeem it now:`)
    case 12:
